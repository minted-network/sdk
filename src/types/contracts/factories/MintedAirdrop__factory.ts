...
import type { MintedAirdrop, MintedAirdropInterface } from "../MintedAirdrop";
...
export class MintedAirdrop__factory {
  static readonly abi = _abi;
  static createInterface(): MintedAirdropInterface {
    return new utils.Interface(_abi) as MintedAirdropInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MintedAirdrop {
    return new Contract(address, _abi, signerOrProvider) as MintedAirdrop;
  }
}
