...
import type {
  RoyaltyFeeSetter,
  RoyaltyFeeSetterInterface,
} from "../RoyaltyFeeSetter";
...
export class RoyaltyFeeSetter__factory {
  static readonly abi = _abi;
  static createInterface(): RoyaltyFeeSetterInterface {
    return new utils.Interface(_abi) as RoyaltyFeeSetterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RoyaltyFeeSetter {
    return new Contract(address, _abi, signerOrProvider) as RoyaltyFeeSetter;
  }
}
