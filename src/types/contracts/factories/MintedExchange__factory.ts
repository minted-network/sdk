...
export class MintedExchange__factory {
  static readonly abi = _abi;
  static createInterface(): MintedExchangeInterface {
    return new utils.Interface(_abi) as MintedExchangeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MintedExchange {
    return new Contract(address, _abi, signerOrProvider) as MintedExchange;
  }
}
