...
import type {
  BalliesCheerleaders,
  BalliesCheerleadersInterface,
} from "../BalliesCheerleaders";
...
export class BalliesCheerleaders__factory {
  static readonly abi = _abi;
  static createInterface(): BalliesCheerleadersInterface {
    return new utils.Interface(_abi) as BalliesCheerleadersInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BalliesCheerleaders {
    return new Contract(address, _abi, signerOrProvider) as BalliesCheerleaders;
  }
}
